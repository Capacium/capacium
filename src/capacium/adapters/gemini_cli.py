...
class GeminiCLIAdapter(FrameworkAdapter):
    ...
    def __init__(self):
        ...
        self.skills_dir = Path.home() / ".gemini" / "skills"
        self.legacy_capabilities_dir = Path.home() / ".gemini" / "capabilities"
    ...
    def remove_skill(self, cap_name: str, owner: str = "global") -> bool:
        for skills_dir in (self.skills_dir, self.legacy_capabilities_dir):
