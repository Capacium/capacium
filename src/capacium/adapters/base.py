...
class FrameworkAdapter(ABC):
    def install_capability(self, cap_name: str, version: str, source_dir: Path, owner: str = "global", kind: str = "") -> bool:
    ...
    def remove_capability(self, cap_name: str, owner: str = "global", kind: str = "") -> bool:
        if kind == CapaciumKind.MCP.value:
